...
/**
 * 过滤参数，筛选出符合要求的参数数组
 * @param {!undefined} argumentsList  实际参数列表  接受非undefined的任意原始数据类型参数，非数组参数，会先转成数组表
 * @param {Array||String} typeList 从argumentsList里筛选出typeList需要的类型列表:仅接受字符串和数组，数组中的元素也必须是字符串格式
