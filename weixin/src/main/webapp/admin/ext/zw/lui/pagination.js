	...
	me.config = {
		...
		callback: {
			...
			loadCallback: function ($addNode, pagingO) {
				...
				pagingO.$content.undelegate(".paging-limit .limit", "change");
				//为每页限制条数绑定事件
				pagingO.$content.delegate(".paging-limit .limit", "change", function () {
				...
				pagingO.$content.undelegate(".paging-jump .jump", "change");
				//为跳到指定页绑定事件
				pagingO.$content.delegate(".paging-jump .jump", "change", function () {
